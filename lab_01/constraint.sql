...
ALTER table public.typies_company
    ADD CONSTRAINT pk_type_id primary key(id),
    ALTER COLUMN name SET NOT NULL;    

ALTER table public.games 
    ADD CONSTRAINT fk_developer foreign key(developer) references public.companies(id) ON DELETE SET NULL,
    ADD CONSTRAINT fk_publisher foreign key(publisher) references public.companies(id) ON DELETE SET NULL,
    ALTER COLUMN name SET NOT NULL,
...
ALTER table public.categories
    ADD CONSTRAINT fk_gameid foreign key(gameid) references public.games(id) ON DELETE CASCADE,
    ADD CONSTRAINT fk_genreid foreign key(genreid) references public.genres(id) ON DELETE CASCADE,
    ALTER COLUMN gameid SET NOT NULL,
    ALTER COLUMN genreid SET NOT NULL;

ALTER table public.platforms 
    ADD CONSTRAINT fk_manufacturer foreign key(manufacturer) references public.companies(id) ON DELETE SET NULL,
    ALTER COLUMN name SET NOT NULL,
...
ALTER table public.supports
    ADD CONSTRAINT fk_gameid foreign key(gameid) references public.games(id) ON DELETE CASCADE,
    ADD CONSTRAINT fk_platformid foreign key(platformid) references public.platforms(id) ON DELETE CASCADE,
    ALTER COLUMN gameid SET NOT NULL,
...
ALTER table public.sales
    ADD CONSTRAINT fk_gameid foreign key(gameid) references public.games(id) ON DELETE CASCADE,
    ADD CONSTRAINT fk_clientid foreign key(clientid) references public.clients(id) ON DELETE CASCADE,
    ALTER COLUMN gameid SET NOT NULL,
    ALTER COLUMN clientid SET NOT NULL;

ALTER table public.companies 
    ADD CONSTRAINT fk_type foreign key(type) references public.typies_company(id) ON DELETE SET NULL,
    ALTER COLUMN name SET NOT NULL,
